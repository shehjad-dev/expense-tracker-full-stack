...
const Expenses = () => {
    ...
    return (
        <div className="h-full w-full py-[60px] px-[100px] relative">
            ...
            <div className="mt-4 flex gap-2 w-fit ml-auto">
                <DropdownMenu>
...
// const Expenses = () => {
//     const [page, setPage] = useState(1);
//     const [dataType, setDataType] = useState<'summary' | 'daily'>('summary'); // New state for data type
//     const [sortBy, setSortBy] = useState<'newest' | 'oldest'>('newest'); // New state for sortBy
//     const [expenseType, setExpenseType] = useState<'recurring' | 'non-recurring' | undefined>(undefined); // New state for expenseType
//     const limit = 5;

//     const { data, isLoading, error } = useGetExpensesQuery({ page, limit });
...
//         }, [] as { category: string; amount: number }[])
//         : expenses.reduce((acc, expense) => {
//             const date = new Date(expense.createdAt).toLocaleDateString(); // Group by day
//             const existing = acc.find((item) => item.date === date);
//             if (existing) {
//                 existing.amount += expense.amount;
//             } else {
...
//                 </DropdownMenu>
//             </div>
//             <div className="mt-6 overflow-y-auto min-h-[280px] max-h-[600px]">
//                 <Table className='rounded-lg overflow-hidden'>
//                     <TableHeader>
//                         <TableRow className='bg-rose-50 dark:bg-rose-500/10'>
//                             <TableHead>Name</TableHead>
